...
- Intent should ONLY be specific (apply_leave, apply_miss_punch, apply_gate_pass, attendance_report, payslip) when the user is actually REQUESTING or APPLYING that action.
